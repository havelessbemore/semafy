[semafy - v1.0.1](../README.md) / [Exports](../modules.md) / SemaphoreError
...
Defined in: [src/semaphoreError.ts:8](https://github.com/havelessbemore/semafy/blob/33d1ef9/src/semaphoreError.ts#L8)
